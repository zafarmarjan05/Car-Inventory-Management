...
// Query to fetch only sold cars
$sql = "SELECT id, make, model, year, color, plate, photo FROM cars WHERE status = 'sold' AND hide = 0";
    ...
    <style>
        ...
        * {
        ...
        .car-card {
            ...
            border-radius: 15px;
            overflow: hidden;
            box-shadow: 0 8px 20px rgba(174, 64, 64, 0.08);
            transition: var(--transition);
        ...
        .availability-badge {
            background: rgba(181, 135, 139, 0.1);
            color: #eb1e0bff;
            padding: 0.5rem 1rem;
            border-radius: 20px;
            font-size: 0.85rem;
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="sold-cars.php" class="nav-link active">
                    <i class="bi bi-cart-check-fill"></i>
                    <span>Sold Cars</span>
                </a>
            </div>
    ...
    <div class="main-content" id="mainContent">
        <div class="page-header">
            <h1 class="page-title">Sold Cars</h1>
            <p class="page-subtitle">Monitor and track your sold inventory</p>
        </div>
        ...
        <div class="cars-container">
            <div class="section-header">
                ...
                <div class="cars-count">
                    <?php echo ($result && $result->num_rows > 0) ? $result->num_rows : 0; ?> Cars Sold
                </div>
            </div>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <h3 class="empty-title">No Sold Cars</h3>
                    <p class="empty-text">
                        There are currently no cars marked as sold in your inventory.
                    </p>
