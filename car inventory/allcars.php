...
// echo "<h2>All Cars in Inventory</h2>";
// echo "<table border='1'>
// <tr>
//     <th>ID</th>
//     <th>Make</th>
...
<head>
    ...
    <title>allcars - Car Inventory</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="view-cars.php" class="nav-link active">
                    <i class="bi bi-collection-fill"></i>
                    <span>All Cars</span>
                </a>
            </div>
                        ...
                        <div class="car-card">
                            ...
                            <div class="car-details">
                                ...
                                <?php if ($row['status'] === 'sold'): ?>
                                    <div class="sold-badge" style="background: rgba(255, 0, 0, 0.1); color: #b00020; margin-top: 1rem;">
